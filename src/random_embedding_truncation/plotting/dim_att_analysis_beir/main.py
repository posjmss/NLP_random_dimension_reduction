...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=str, default="./figures/dim_att_analysis_beir")
    ...
    if not summary_paths:
        raise FileNotFoundError(f"No BEIR summary JSON files found in {summary_dir}")

    for summary_path in summary_paths:
        model_name = model_name_from_summary(summary_path)
        baseline_path = summary_dir / f"{model_name}__beir.baseline.json"
        ...
        plot_model(
            ...
            baseline=baseline,
            metric=args.metric,
            output_path=output_dir / f"{model_name}__beir.png",
