...
from random_embedding_truncation.dimension_attribution_analysis_finmteb.collect_results import (
    add_mean_metrics,
...
if __name__ == "__main__":
    ...
    for task in config.task_list:
        ...
        print(f"Saved full-embedding FinMTEB baseline for {task} to {output_folder}")
    ...
    print(f"Saved flat FinMTEB baseline summary to {config.summary_output_path}")
